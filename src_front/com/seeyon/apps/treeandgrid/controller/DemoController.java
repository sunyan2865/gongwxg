package com.seeyon.apps.treeandgrid.controller;
...
import com.seeyon.apps.treeandgrid.po.*;
import com.seeyon.apps.treeandgrid.util.CommonUtil;
...
public class DemoController extends BaseController {
	...
	public ModelAndView demo(HttpServletRequest request,HttpServletResponse response)throws Exception {
		LOG.info("进入demo");
		response.setContentType("text/html;charset=UTF-8");
		ModelAndView view  = new ModelAndView("treeandgrid/demo");
		if(demoManager == null) {
			demoManager = (DemoManager)AppContext.getBean("demoManager");
		}
		List<TemplateTreeVo> demoLeft = demoManager.demoLeft();
		request.setAttribute("fftree", demoLeft);
		return view;
	...
	public ModelAndView demoRight(HttpServletRequest request,HttpServletResponse response)throws Exception{
		response.setContentType("text/html;charset=UTF-8");
		ModelAndView view = new ModelAndView("treeandgrid/demoRight");
	...
	public ModelAndView toEditDemoView(HttpServletRequest request, HttpServletResponse response) throws Exception {
		ModelAndView modelAndView = new ModelAndView("treeandgrid/demoDetail");
	...
	public ModelAndView toNodeReplaceView(HttpServletRequest request,HttpServletResponse response)throws Exception{
		ModelAndView modelAndView = new ModelAndView("treeandgrid/nodeReplace");
		String summaryid=request.getParameter("summaryid");
