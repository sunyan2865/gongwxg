...
public class SectionPortal_hgxx extends BaseSectionImpl {

    private ReadConfigTools configTools = new ReadConfigTools();

    public SectionPortal_hgxx() {
    }


    @Override
    public String getId() {
        return "SectionPortal_hgxx";
    }

    @Override
    public String getName(Map<String, String> map) {
        String name = "未回告事项(全部)";
    ...
    public BaseSectionTemplete projection(Map<String, String> preference) {
        ...
        String sectionUrl = "/seeyon/demo.do?method=toSwhgPortalList";
        ...
        ht.addBottomButton("common_more_label", "/demo.do?method=toSwhgPortalMoreList", HtmlTemplete.OPEN_TYPE.href.name());
