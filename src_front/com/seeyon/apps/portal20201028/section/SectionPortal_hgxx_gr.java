...
public class SectionPortal_hgxx_gr extends BaseSectionImpl {

    private ReadConfigTools configTools = new ReadConfigTools();

    public SectionPortal_hgxx_gr() {
    }


    @Override
    public String getId() {
        return "SectionPortal_hgxx_gr";
    }
    ...
    public BaseSectionTemplete projection(Map<String, String> preference) {
        ...
        String sectionUrl = "/seeyon/demo.do?method=toSwhgPortalListGr";
        ...
        ht.addBottomButton("common_more_label", "/demo.do?method=toSwhgPortalMoreListGr", HtmlTemplete.OPEN_TYPE.href.name());
